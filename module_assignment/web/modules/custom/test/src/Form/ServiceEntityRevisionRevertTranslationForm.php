...
/**
 * Provides a form for reverting a Service entity revision for a single trans.
 *
 * @ingroup test
 */
class ServiceEntityRevisionRevertTranslationForm extends ServiceEntityRevisionRevertForm {
  ...
  public function getFormId() {
    return 'service_entity_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $service_entity_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $service_entity_revision);
  ...
  protected function prepareRevertedRevision(ServiceEntityInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\test\Entity\ServiceEntityInterface $default_revision */
