...
jQuery UI Progressbar library for any themes and modules that require
it.

  - jQuery UI [Progressbar documentation](https://jqueryui.com/progressbar/)
  - jQuery UI [Progressbar API documentation](https://api.jqueryui.com/progressbar/)
...
2.  Change any references in your theme or module from
    `core/jquery.ui.progressbar` to `jquery_ui_progressbar/progressbar`
